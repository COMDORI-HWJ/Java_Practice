...

{
    ...
    public VendingBord()
    {
        ...
        VBord.add(ohbakwon,getPoint(0,0,3,4, GridBagConstraints.WEST));

        chunwon = new JButton("천원넣기");
        chunwon.addActionListener(this);
        VBord.add(chunwon, getPoint(0, 1, 0, 3, GridBagConstraints.WEST));

        refund = new JButton("돈반환");
        refund.addActionListener(this);
        VBord.add(refund,getPoint(0,8,5,1, GridBagConstraints.WEST));

        Text = new JLabel("현재 투입된 금액");
        VBord.add(Text,getPoint(0,0,2,2, GridBagConstraints.WEST));
